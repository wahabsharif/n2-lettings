...
const FoundCategory = () => {
  return (
    <>
      <h3 className="text-lg font-bold mb-4">Message us to find out more</h3>
      ...
      <form className="flex flex-col gap-4">
        ...
        <div className="flex items-start gap-2">
          ...
          <label
            htmlFor="agree"
            className="text-sm text-gray-600 dark:bg-gray-900 dark:text-gray-300"
          >
            By using this form, you agree with the storage and handling of your
            data by this website in accordance with our Privacy Policy.
          </label>
        </div>
