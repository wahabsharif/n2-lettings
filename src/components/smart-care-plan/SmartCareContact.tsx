...
const SmartCareContact: React.FC = () => {
    return (
        <div className="container mx-auto px-4 w-full md:max-w-6xl mb-8">
            {/* Heading and Paragraph */}
            <h2 className="text-2xl font-bold text-left mb-4">Contact N2 Lettings-Smart Care Plan</h2>
            ...
            <div className="overflow-x-auto">
                <table className="w-full table-auto border-collapse md:mb-8 border border-gray-400 dark:border-white">
                    <thead>
                        <tr className="bg-white dark:bg-gray-900 border border-gray-400 dark:border-white">
                            <th className="px-4 py-2 border-b  text-left border border-gray-400 dark:border-white">Mitcham Branch</th>
                            <th className="px-4 py-2 border-b  text-left border border-gray-400 dark:border-white">Cheam, Sutton Branch</th>
                        </tr>
                    </thead>
                    <tbody>
                        {branchData.map((row) => (
                            <React.Fragment key={row.id}>
                                ...
                                <tr className="bg-gray-50 dark:bg-gray-900 border border-gray-400 dark:border-white">
                                    <td className="px-4 py-2 border border-gray-400 dark:border-white">
                                ...
                                {/* Second Row: Contact1 */}
                                <tr className="dark:bg-gray-900 border border-gray-400 dark:border-white">
                                    <td className="px-4 py-2 border border-gray-400 dark:border-white">
                                        <Link
...
export default SmartCareContact;
